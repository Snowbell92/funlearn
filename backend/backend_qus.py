...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label4.setText("Write down option 1 answer ")
        ...
        self.label6.setText("Write answer for option 2")
        ...
        self.label8.setText("Write answer for option 3")
        ...
        self.label10.setText("Write answer for option 4")
        ...
        self.labelp.setGeometry(QtCore.QRect(350, 850, 361, 70))
        self.labelp.setText("Write down answer ")
